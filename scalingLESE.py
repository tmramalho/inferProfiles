# Eric Smith, 2015: I copied this code from scalingProfiles.py in order to analyze different time windows and orientations of the LE&SE dataset.
...
if __name__ == '__main__':
	sc = ScalingContainer()
	sc.analysis(plot=True, save_results=True)